...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoWorkApi.Domain.Entities.RoomReservationsConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TimeRangeName")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<int>("TimeRangeValue")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("RoomReservationsConfigs");
                });
            ...
            modelBuilder.Entity("CoWorkApi.Domain.Entities.RoomReservationsConfig", b =>
                {
                    b.HasOne("CoWorkApi.Domain.Entities.Room", "Room")
                        .WithMany("RoomReservationsConfigs")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoWorkApi.Domain.Entities.Room", b =>
                {
                    ...
                    b.Navigation("RoomReservationsConfigs");
                });
